...
class Controller {
 private:
  ...
  std::vector<int> entries;  // CONTAIN THE INDEXES OF THE ENTRIES IN THE MENU
                             // LINES ARRAY WHERE THE CURSOR SHOULD APPEAR
  ...
  bool stop_back;        // STOP THE USER FROM USING THE BACK BUTTON
  bool isWalletCreated;  // IS THE WALLET CREATED
