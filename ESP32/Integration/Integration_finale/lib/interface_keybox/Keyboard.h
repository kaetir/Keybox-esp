...
#define FIELD_WIDTH \
  17  // NUMBER OF COLUMNS - SIZE OF THE MENU CURSOR - SIZE OF THE KEYBOARD
      // CURSOR
...
class Keyboard {
 ...
 public:
  ...
  /**
   * @brief  Select the character of the left(if there is one) of the currently
   * selected character
   * @param cursor_pos  Pointer to the keyboard cursor
  ...
  /**
   * @brief  Select the character of the right(if there is one) of the currently
   * selected character
   * @param cursor_pos  Pointer to the keyboard cursor
   * @param buffer  Pointer to the input field display buffer
   * @param word Pointer to the input field content
   */
  void right(int *cursor_pos, std::vector<int> *buffer,
   ...
   * @param buffer  Pointer to the input field display buffer
   * @param word Pointer to the input field content
   * @param new_char Pointer to the boolean (Is the keyboard cursor at a new
   * character ?)
   * @return  String to display on the input field line
   */
  std::string get_display(int *cursor_pos, std::vector<int> *buffer,
